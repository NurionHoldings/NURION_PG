...
class Tests(unittest.TestCase):
 ...
 def test_sequence_and_idempotency(self):
  ...
  a=r.admit("SYNTHETIC_SHADOW_READINESS_REVIEW_COMPLETED","HOLD",("BLOCK",),"synthetic:key:a");self.assertIs(a,r.admit("SYNTHETIC_SHADOW_READINESS_REVIEW_COMPLETED","HOLD",("BLOCK",),"synthetic:key:a"))
  with self.assertRaises(GovernanceRejected):r.admit("BAD","HOLD",("BLOCK",),"synthetic:key:a")
