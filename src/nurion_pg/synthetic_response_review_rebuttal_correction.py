...
APPLIED_LESSONS=("ARL-3901-001","ARL-4301-001","ARL-4301-002","ARL-4301-003","ARL-4701-001","ARL-5101-001","ARL-5501-001","ARL-5901-001","ARL-6301-001","ARL-6701-001","ARL-7101-001","ARL-7501-001","ARL-7901-001","ARL-8301-001","ARL-8701-001","ARL-9101-001","ARL-9501-001");APPLIED_RULES=tuple(f"ARP-{i:02}" for i in range(1,9));SOURCE_ROLE_KINDS=("readiness-reviewer","preflight-reviewer","reconsideration-reviewer")+("packet-compiler",)*4+("human-deliberation-chair","cross-party-validator","issue-matrix-compiler","issue-matrix-validator","clarification-drafter","clarification-reviewer","response-intake-compiler","response-intake-validator")
